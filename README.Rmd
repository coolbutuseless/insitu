...
In-situ operations on vectors can be performed using the `br_*()` functions 
in this package.
...
A third version of the function (`conv_vec_insitu()`) replaces the code with functions
from `{insitu}`.
